...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/multi_rake-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8992&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/multi_rake-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `multi_rake` can be installed with:

```
conda install multi_rake
```

It is possible to list all of the versions of `multi_rake` available on your platform with:
